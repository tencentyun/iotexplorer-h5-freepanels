...
import { AirConditionerFuncFooter } from './AirConditionerFuncFooter';
import sdk from 'qcloud-iotexplorer-h5-panel-sdk';
import './AirConditionerPanelLayout.less';
...
export function AirConditionerPanelLayout({
    children,
    className,
    style,
    doControlDeviceData,
