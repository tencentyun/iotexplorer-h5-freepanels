...
import { Home_colorful } from './views/home_colorful/home_colorful';
import { Home_dark } from './views/home-dark/home_dark';
import { Home_blueWhite } from './views/home_blueWhite/home_blueWhite';
import { DeviceSateContext } from './deviceStateContext';
import 'antd-mobile/es/global';
import '@icons/themes/icons/svg/emergency-button';
...
export const App = QuicknessMode(() => {
  ...
  const getHomePage = () => {
    if (themeType == 'blueWhite') {
      return <Home_blueWhite />;
    } if (themeType == 'colorful') {
      return <Home_colorful />;
    } if (themeType == 'dark') {
      return <Home_dark />;
