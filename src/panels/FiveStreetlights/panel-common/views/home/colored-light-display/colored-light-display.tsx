...
export function ColoredLightDisplay() {
  ...
  useEffect(() => {
    ...
    let temp_r = (sdk.deviceData.color_temp - 2000) / (7000 - 2000);
  ...
  const moveDisplayDot = (clientX, clientY, endTouch)=>{
    let wrap = document.getElementById('colored-light-display-content');
    let point = document.getElementById('colored-light-display-dot');
    let wrap_y = document.getElementById("colored-light-display-content").getBoundingClientRect().y;
