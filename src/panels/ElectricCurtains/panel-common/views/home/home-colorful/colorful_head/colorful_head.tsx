...
export function Colorful_head() {
  ...
  return (
    <article id={'colorful_head'} className={classNames('colorful_head')}>
      <div className={'colorful_head_card'}>
        ...
        <div className="dark_head_img">
          ...
          <div id="dark_leave_wrap" className="dark_leave_wrap">
            ...
            <div className="dark_leave_div"><img className="dark_leaves"
                                                 src="https://tencent-1305105198.cos.ap-guangzhou.myqcloud.com/electric-curtain/curtains-curtain-leaves-colorful.png"
                                                 alt=""/></div>
            {/* <div className="dark_leave_div"><img className="dark_leaves" src="https://tencent-1305105198.cos.ap-guangzhou.myqcloud.com/electric-curtain/curtains-curtain-leaves-colorful.png" alt="" /></div>
                  <div className="dark_leave_div"><img className="dark_leaves" src="https://tencent-1305105198.cos.ap-guangzhou.myqcloud.com/electric-curtain/curtains-curtain-leaves-colorful.png" alt="" /></div> */}
