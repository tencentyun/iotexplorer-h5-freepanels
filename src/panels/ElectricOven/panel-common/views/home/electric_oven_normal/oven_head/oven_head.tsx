...
export function Oven_head() {
  ...
  const getStateStr = () => {
    ...
    } if (sdk.deviceData.work_state == 7) {
      return <div className="span_center center_paused">结束</div>;
    } return <div className="span_center center_standby">待机</div>;
  };
