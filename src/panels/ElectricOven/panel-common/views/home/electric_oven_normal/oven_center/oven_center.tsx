  ...
  const onDetail = ( name: string, heat: string, type: string, up: number, down: number, time: number) => {
    ...
    if(sdk.deviceData.power_switch === 1){
      ...
      apiControlDeviceData({
        work_type: name, heat_mode:heat, heat_type:type, temperature_set_up:up,temperature_set_down:down,remaining_time:time,TimeOfAppointment:time
      });
      theDetail(true);
    }
  }
    ...
    <article id={'oven_center'} className={classNames('oven_center')}>
      <div className="center_card">
        ...
        <div className="card_center">
          ...
          >
            <div className='work_card_icon'>
              <SvgIcon name={'icon-electric-oven-cupcakes-' + themeType} color="#0F0F0F" width={87} height={90}/>
            </div>
          ...
          >
            <div className='work_card_icon'>
              <SvgIcon name={'icon-electric-oven-butter-cookies-' + themeType} color="#0F0F0F" width={87} height={90}/>
            </div>
          ...
          >
            <div className='work_card_icon'>
              <SvgIcon name={'icon-electric-oven-roast-shrimp-' + themeType} color="#0F0F0F" width={87} height={90}/>
            </div>
          ...
          >
            <div className='work_card_icon'>
              <SvgIcon name={'icon-electric-oven-roast-sharkfin-' + themeType} color="#0F0F0F" width={87} height={90}/>
            </div>
        ...
        <div className="card_foot">
          ...
          >
            <div className='work_card_icon'>
              <SvgIcon name={'icon-electric-oven-rice-' + themeType} color="#0F0F0F" width={87} height={90}/>
            </div>
          ...
          >
            <div className='work_card_icon'>
              <SvgIcon name={'icon-electric-oven-pizza-' + themeType} color="#0F0F0F" width={87} height={90}/>
            </div>
          ...
          >
            <div className='work_card_icon'>
              <SvgIcon name={'icon-electric-oven-roast-potato-' + themeType} color="#0F0F0F" width={87} height={90}/>
            </div>
          ...
          >
            <div className='work_card_icon'>
              <SvgIcon name={'icon-electric-oven-dough-ferment-' + themeType} color="#0F0F0F" width={87} height={90}/>
            </div>
