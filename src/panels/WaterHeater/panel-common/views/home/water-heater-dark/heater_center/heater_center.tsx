...
export function Normal_Center() {
  ...
  return (
    <article id={'dark_center'} className={classNames('dark_center')}>
      <div className="normal_card">
        <div className="center_botton" onClick={onAutomatic}>
          <SvgIcon
            name={sdk.deviceData.power_switch == 1 && 'icon-water-heater-automatic-dark2' || 'icon-water-heater-automatic-dark'}
            width={82} height={82}/>
        ...
        <div className="center_botton" onClick={onTwo_Thousand}>
          <SvgIcon
            name={sdk.deviceData.power_switch == 1 && 'icon-water-heater-2000w-dark2' || 'icon-water-heater-2000w-dark'}
            width={82} height={82}/>
          <div className="botton_font">
        ...
        <div className="center_botton" onClick={onSetup}>
          <SvgIcon
            name={sdk.deviceData.power_switch == 1 && 'icon-water-heater-more-dark2' || 'icon-water-heater-more-dark'}
            width={74} height={74}/>
