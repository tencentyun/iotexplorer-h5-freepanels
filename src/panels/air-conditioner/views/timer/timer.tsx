...
import WorkMode, {
  enumWorkMode
} from '@/products/air-conditioner/views/home/components/tools-bar/work-mode/work-mode';
import { Modal } from '@/components/base';
import IconChecked from '@/components/base/icon-checked/icon-checked';
import Gear, {
  enumGear
} from '@/products/air-conditioner/views/home/components/tools-bar/gear/gear';
